...
<head>
    ...
    <title><?php echo e($title ?? 'Alira CRM'); ?></title>
        ...
        <div class="app-frame">
            <aside class="sidebar" aria-label="Navegação principal">
                ...
                <div class="workspace-switcher">
                    <div class="workspace-avatar"><?php echo e(strtoupper(substr($organization->name ?? 'AD', 0, 2))); ?></div>
                    <div class="workspace-copy">
                        <strong><?php echo e($organization->name ?? 'Alira Demo'); ?></strong>
                        <small><?php echo e($store->name ?? 'Loja ativa'); ?></small>
                    </div>
                ...
                <nav class="side-nav">
                    ...
                    <a class="<?php echo e(request()->routeIs('deals.*') ? 'active' : ''); ?>" href="<?php echo e(route('deals.index')); ?>">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"></polygon></svg>
                        <span>Funil de Vendas</span>
                    </a>
                    <a class="<?php echo e(request()->routeIs('conversations.*') ? 'active' : ''); ?>" href="<?php echo e(route('conversations.index')); ?>">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                        <span>Central WhatsApp</span>
                    </a>
                    <a class="<?php echo e(request()->routeIs('customers.*') ? 'active' : ''); ?>" href="<?php echo e(route('customers.index')); ?>">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                        <span>Clientes</span>
                    </a>
                    <a class="<?php echo e(request()->routeIs('sales.*') ? 'active' : ''); ?>" href="<?php echo e(route('sales.index')); ?>">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
                        <span>Vendas & PDV</span>
                    </a>
                    <a class="<?php echo e(request()->routeIs('products.*') ? 'active' : ''); ?>" href="<?php echo e(route('products.index')); ?>">
                ...
                <div class="pdv-shortcut-card">
                    ...
                    <a href="<?php echo e(route('sales.create')); ?>" class="btn-fast-pos">+ Nova Venda</a>
                </div>
            ...
            <div class="main-area">
                <header class="main-header">
                    <div class="mobile-brand">
                        <a class="brand" href="<?php echo e(route('dashboard')); ?>">Alira <span>CRM</span></a>
                    </div>
                    <div class="header-actions">
                        <form action="<?php echo e(route('customers.index')); ?>" method="GET" class="search-box">
                            ...
                            <input type="text" name="search" placeholder="Buscar cliente, WhatsApp, pedidos..." value="<?php echo e(request('search')); ?>" style="border:none; outline:none; background:transparent; width:100%; font-size:13px; color:inherit;">
                            <kbd>⌘K</kbd>
                        </form>
                        <a href="<?php echo e(route('conversations.index')); ?>" class="icon-button" title="Central WhatsApp" aria-label="Atendimentos">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                        </a>
...
<?php /**PATH C:\Users\Isaias\Downloads\alira-crm-laravel-mvp\resources\views/layouts/app.blade.php ENDPATH**/ ?>